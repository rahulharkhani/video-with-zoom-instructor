 ...
 *
 * Plugin Name:       Video Conferencing with Zoom Instructor based
 * Plugin URI:        https://wordpress.org/plugins/video-conferencing-with-zoom-api/
 * Description:       Video Conferencing with Zoom Meetings and Webinars plugin provides you with great functionality of managing Zoom meetings, Webinar scheduling options, Instructor based Settings, and users directly from your WordPress dashboard.
 * Version:           3.8.12
...
/* custom code to assign setting menu to admin and teacher role */
$admin = get_role('administrator');
$teacher = get_role('lp_teacher');

$admin->add_cap('zoom_menu_access');
$teacher->add_cap('zoom_menu_access');